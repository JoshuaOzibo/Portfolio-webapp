...
const navbar = () => {
  ...
  return (
    <div>
      <div className="flex px-10 bg-red-500 py-1.5 fixed border-b border-gray-200 xl:w-[100%] lg:w-[78%] w-full flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div className="">
